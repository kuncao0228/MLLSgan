...
class CycleGANSemNoTextModel(BaseModel):
    """
    ...
    def __init__(self, opt):
        ...
        print("Using Cycle GAN semantics no text!!!!!")
        self.applytext = 0.0
        ...
        if self.isTrain:  # define discriminators
            ...
            self.netD_TA = networks.define_D(opt.input_nc, opt.ndf, 'Sem_Adaptive',
                                            opt.n_layers_D, opt.norm, opt.init_type, opt.init_gain, self.gpu_ids)
    ...
    def backward_Dadaptive(self, netD, real, fake, dissimilar):
        ...
        #dissimilar
        pred_dissimilar = netD(*dissimilar)
        loss_D_dissimilar = self.criterionGAN(pred_dissimilar, False)
    ...
    def backward_D_TA(self):#To be changed
        ...
        self.loss_D_TA = self.backward_Dadaptive(self.netD_TA, (self.real_B ,self.real_T_B.view(1, -1, 300)), (fake_image, self.real_T_B.view(1, -1, 300)), (self.real_B, self.text_B_wrong.view(1, -1, 300)))
    ...
    def backward_G(self):
        ...
        fakeimg_realtext_similar = self.netD_TA(self.fake_B, self.real_T_A.view(1, -1, 300))
        
        self.loss_G_A = self.criterionGAN(fakeimg_realtext_similar, True) * self.scale
